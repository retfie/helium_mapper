...
If bootloader doesn't build with auto DFU reboot, please reboot device manually. Here is what dmesg should show:
```
...
( Just make sure that it has mcuboot support and mcuboot shell capabalities, to confirm any new image uploaded ).
